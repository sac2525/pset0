...
1 - Go to `Tools` -> `Global Options...` -> `R Markdown` and unselect `Show output inline for all R Markdown documents`

2 - Within the same menu, go to `Pane Layout` and select `Console` on the top-right panel.
